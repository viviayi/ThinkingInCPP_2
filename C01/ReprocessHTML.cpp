// Take Word's html output and fix up the code listings and html tags
#include "../require.h"
#include <iostream>
#include <fstream>
#include <string>
using namespace std;
// Produce a new string which is the original string with the html paragraph break marks stripped off:
...
// After the beginning of a code listing is detecte, this function cleans up the listing
// until the end marker is found. The first line of the listing is passed in by the caller,
// which detects the start marker in the line.
void fixupCodeListing(istream& in, ostream& out, string& line, int tag){
    out << line.substr(0, tag) << "<PRE>" // Means "preformatted" in html
...
int main(int argc, char* argv[]){
    ...
    while(getline(in, line)){
        ...
        if(line.find("<BODY>") != string::npos){
            out << "<BODY BGCOLOR=\"#FFFFFF\" TEXT=\"#000000\">" << endl;
